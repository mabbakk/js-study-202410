...
let copy1 = numbers.slice(3);  // end 생략 시 끝까지 분할
console.log(copy1);
let copy2 = numbers.slice();   //둘 다 생략 시 처음부터 끝까지 -> 전체복제
console.log(copy2);
...
// 배열 원본이 손상된 : 안전한 작업을 위해서는 복사하고서 작업
...
//중간 삽입 기능
foodList.splice(2, 0, '짜장면') // 2번 객체 0번 삭제, 즉 삭제 하지 말고 2번 자리에 짜장면을 넣어라
console.log(foodList);
