...
// let divCount = calcDivisor(20); //함수calc을 정의하여 내부에 배열 생성 후 console.log 출력

function calcDivisor(n) {
    let divisor = []; // 약수의 개수를 저장할 변수
...
let divCount = calcDivisor(20); // n의 약수의 개수를 변수에 저장
console.log(`약수의 개수: ${divisorCount}개`);
